...
@section('content')
<h5 class="py-3 mb-4"><span class="text-muted fw-light">Masters/</span> Update Executive</h5>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('masters.executives.update',$executive->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter your Name" value="{{ old('name',$executive->name) }}">
                            @error('name') <div class="text-danger mt-1 small">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Mobile Number</label>
                            <input type="text" name="mobile" class="form-control" placeholder="Enter 10-digit mobile number" value="{{ old('mobile',$executive->mobile) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="address" class="form-control" placeholder="Enter your Address" value="{{ old('address',$executive->address) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="state_id" id="state-select" class="form-control">
                                ...
                                <option value="{{ $state->id }}" {{ old('state_id',$executive->state_id) == $state->id ? 'selected' : '' }}>{{ $state->state_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-12 d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm">Update Executive</button>
                        </div>
                    </div>
                </form>
